...
describe Nelumba::Image do
  describe "#initialize" do
    it "should store an author" do
      author = mock('author')
      Nelumba::Image.new(:author => author).authors.first.must_equal author
    end

    it "should store multiple authors" do
      author  = mock('author')
      author2 = mock('author')
      Nelumba::Image.new(:authors => [author, author2]).authors.must_equal [author, author2]
    end
  ...
  describe "#to_hash" do
    ...
    it "should contain the author" do
      ...
      Nelumba::Image.new(:author => author).to_hash[:authors].first.must_equal author
    end

    it "should contain multiple authors" do
      author  = mock('Nelumba::Person')
      author2 = mock('Nelumba::Person')
      Nelumba::Image.new(:author => [author, author2]).to_hash[:authors].must_equal [author, author2]
    end
